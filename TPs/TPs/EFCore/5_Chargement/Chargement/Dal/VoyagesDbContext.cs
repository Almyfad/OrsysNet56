...
namespace Chargement.Dal
{
    public partial class VoyagesDbContext : DbContext
    {
        ...
        public virtual DbSet<VReservation> VReservations { get; set; } = null!;
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<VReservation>(entity =>
            {
                ...
                entity.Property(e => e.NomClient).HasMaxLength(30);
